...
COMMANDS = [
    ...
    ("MODEL SWITCHING", [
    ("/model auto", "Auto-route each task to the best local model"),
    ("/model local", "Use the default local Ollama model"),
    ("/model local_coder", "qwen2.5-coder:7b — code"),
    ("/model local_reason", "deepseek-r1:8b — reasoning / debug"),
    ("/model local_general", "qwen3.5:9b — general (Arabic)"),
    ("/model local_fast", "qwen3.5:4b — fast / short tasks"),
    ]),
    ("SYSTEM", [
